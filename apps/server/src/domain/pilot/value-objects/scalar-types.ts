...
export const ProductLabelSchema = S.Trim
  .pipe(S.minLength(1),
...
export const ProductDescriptionSchema = S.String
  .pipe(S.maxLength(DESCRIPTION_MAX_LENGTH),
...
export const PriceSchema = S.Number
  .pipe(S.int(), S.positive(), S.brand('Price'))
...
export const PositiveCmSchema = S.Number
  .pipe(S.int(), S.positive(), S.brand('PositiveCm'))
